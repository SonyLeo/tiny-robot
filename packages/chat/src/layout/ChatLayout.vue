...
import { computed, useModel, useSlots, useTemplateRef } from 'vue'
...
const modeState = useModel(props, 'mode')
const floatingState = useModel(props, 'floating')
...
<template>
  <div v-show="!isFloating" class="tr-chat-layout-host" data-part="surface-host">
