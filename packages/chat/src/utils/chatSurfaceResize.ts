import type { ChatFloatingConfig, ChatPlacement } from '@/types/layout'
import { DEFAULT_FLOATING_GAP, toCommittedFloatingConfig, type FloatingSnapshot } from '@/utils/chatSurfaceGeometry'
