...
const chatSource = readFileSync(fileURLToPath(new URL('../src/components/chat/Chat.vue', import.meta.url)), 'utf8')
const defaultRendererSource = readFileSync(
  fileURLToPath(new URL('../src/components/chat/ChatDefaultRenderer.vue', import.meta.url)),
  'utf8',
)
const workspaceLayoutSource = readFileSync(
  fileURLToPath(new URL('../src/components/chat/ChatWorkspaceLayout.vue', import.meta.url)),
  'utf8',
)
const workspaceLeftSheetSource = readFileSync(
  fileURLToPath(new URL('../src/components/chat/workspace/ChatWorkspaceLeftSheet.vue', import.meta.url)),
  'utf8',
)
const workspaceRightSheetSource = readFileSync(
  fileURLToPath(new URL('../src/components/chat/workspace/ChatWorkspaceRightSheet.vue', import.meta.url)),
  'utf8',
)
