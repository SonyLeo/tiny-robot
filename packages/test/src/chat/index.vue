<template>
  <div class="chat-demo">
    ...
    <div class="mode-switcher">
      ...
      <button
        data-testid="switch-preset-entry"
        :class="{ active: mode === 'preset-entry' }"
        @click="mode = 'preset-entry'"
      >
        Preset Entry
      </button>
      <button
    ...
    <div v-if="mode === 'preset-entry'" data-testid="chat-preset-entry" class="chat-wrapper">
      <TrChat.PresetRoot
