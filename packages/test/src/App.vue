  ...
  <div class="app">
    ...
    <nav>
      <ul>
        ...
        <li><a href="/markdown" @click.prevent="currentComponent = 'Markdown'">Markdown 组件</a></li>
...
import MarkdownDemo from './markdown/index.vue'
import SenderDemo from './sender/index.vue'

type ComponentName = 'Home' | 'Attachments' | 'Container' | 'Markdown' | 'Sender'
