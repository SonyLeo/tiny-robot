...
.mention-list {
  background: var(--tr-sender-mention-list-bg);
  border-radius: 12px;
  box-shadow: var(--tr-sender-mention-list-shadow);
  padding: 6px;
  max-height: 320px;
  overflow-y: auto;
  max-width: 320px;
  ...
  &::-webkit-scrollbar-thumb {
    background: var(--tr-sender-mention-scrollbar-thumb);
    border-radius: 4px;
    border: 2px solid transparent;
    background-clip: padding-box;

    &:hover {
      background: var(--tr-sender-mention-scrollbar-thumb-hover);
      background-clip: padding-box;
    }
  }
}
...
.mention-item {
  ...
  &:hover {
    background: var(--tr-sender-mention-item-hover-bg);
  }

  &.is-selected {
    background: var(--tr-sender-mention-item-selected-bg);
  }
}
...
.mention-label {
  ...
  font-size: 15px;
  font-weight: 500;
  color: var(--tr-sender-mention-text-primary);
  overflow: hidden;
...
.mention-empty {
  padding: 20px 12px;
  text-align: center;
  color: var(--tr-sender-mention-text-tertiary);
  font-size: 14px;
}
</style>
