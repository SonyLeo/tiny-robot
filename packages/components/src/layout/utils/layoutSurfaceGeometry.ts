import type { LayoutFloatingConfig } from '../index.type'
import { resolveCssLengthToPx } from './cssLength'
...
function resolveWidthLimits(source: LayoutFloatingConfig | undefined, measurementRoot: HTMLElement | null) {
...
export function areFloatingGeometryEqual(
  left: Pick<LayoutFloatingConfig, 'x' | 'y' | 'width' | 'height'> | undefined,
  right: Pick<LayoutFloatingConfig, 'x' | 'y' | 'width' | 'height'> | undefined,
): boolean {
