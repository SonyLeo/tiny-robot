const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/size.DPAg6SVV.js","assets/chunks/theme.C1DhrVWI.js","assets/chunks/framework.U4597d8b.js","assets/chunks/methods-demo.CHur587I.js","assets/chunks/custom-slots.kKvus6-t.js","assets/chunks/submit-type.Dsl_B6yg.js","assets/chunks/cancel-event.CVwrovvo.js","assets/chunks/attachments-in-sender.DpCr0A_v.js","assets/chunks/actions-enhanced.mP2qxd-0.js","assets/chunks/actions-config-basic.stJSoYl5.js","assets/chunks/voice-custom-ui.BchSddrL.js","assets/chunks/voice-custom.CHZki7uP.js","assets/chunks/voice-input.D7hmv4NQ.js","assets/chunks/suggestion-highlight.C5f0bTj8.js","assets/chunks/suggestion-filter.B2b5Yr0b.js","assets/chunks/suggestion-basic.Be_ZNGi1.js","assets/chunks/mention.Crku5MJC.js","assets/chunks/template-editor.M0iLKevW.js","assets/chunks/word-limit.e7E627W3.js","assets/chunks/loading-state.BXMJ6W0f.js","assets/chunks/mode-switch.Q9MdoKMG.js"])))=>i.map(i=>d[i]);
import{aD as p,bQ as r,aZ as V,aL as P,v as R,H as m,bL as h,bB as c,J as s,bk as n,bJ as a,G as k,w as l,I as d,b7 as u,aU as z}from"./chunks/framework.U4597d8b.js";import{L as g,N as y}from"./chunks/index.iUw3Fsxy.js";const L=`<script setup lang="ts">
...
`,rt=JSON.parse('{"title":"Sender 消息输入框","description":"","frontmatter":{"outline":[1,3]},"headers":[],"relativePath":"components/sender.md","filePath":"components/sender.md"}'),lt={name:"components/sender.md"},ht=Object.assign(lt,{setup(dt){const E=u();p(async()=>{E.value=(await r(async()=>{const{default:i}=await import("./chunks/size.DPAg6SVV.js");return{default:i}},__vite__mapDeps([0,1,2]))).default});const b=u();p(async()=>{b.value=(await r(async()=>{const{default:i}=await import("./chunks/methods-demo.CHur587I.js");return{default:i}},__vite__mapDeps([3,1,2]))).default});const v=u();p(async()=>{v.value=(await r(async()=>{const{default:i}=await import("./chunks/custom-slots.kKvus6-t.js");return{default:i}},__vite__mapDeps([4,1,2]))).default});const f=u();p(async()=>{f.value=(await r(async()=>{const{default:i}=await import("./chunks/submit-type.Dsl_B6yg.js");return{default:i}},__vite__mapDeps([5,2,1]))).default});const F=u();p(async()=>{F.value=(await r(async()=>{const{default:i}=await import("./chunks/cancel-event.CVwrovvo.js");return{default:i}},__vite__mapDeps([6,1,2]))).default});const A=u();p(async()=>{A.value=(await r(async()=>{const{default:i}=await import("./chunks/attachments-in-sender.DpCr0A_v.js");return{default:i}},__vite__mapDeps([7,1,2]))).default});const D=u();p(async()=>{D.value=(await r(async()=>{const{default:i}=await import("./chunks/actions-enhanced.mP2qxd-0.js");return{default:i}},__vite__mapDeps([8,1,2]))).default});const x=u();p(async()=>{x.value=(await r(async()=>{const{default:i}=await import("./chunks/actions-config-basic.stJSoYl5.js");return{default:i}},__vite__mapDeps([9,1,2]))).default});const C=u();p(async()=>{C.value=(await r(async()=>{const{default:i}=await import("./chunks/voice-custom-ui.BchSddrL.js");return{default:i}},__vite__mapDeps([10,2,1]))).default});const B=u();p(async()=>{B.value=(await r(async()=>{const{default:i}=await import("./chunks/voice-custom.CHZki7uP.js");return{default:i}},__vite__mapDeps([11,1,2]))).default});const T=u();p(async()=>{T.value=(await r(async()=>{const{default:i}=await import("./chunks/voice-input.D7hmv4NQ.js");return{default:i}},__vite__mapDeps([12,2,1]))).default});const S=u();p(async()=>{S.value=(await r(async()=>{const{default:i}=await import("./chunks/suggestion-highlight.C5f0bTj8.js");return{default:i}},__vite__mapDeps([13,2,1]))).default});const _=u();p(async()=>{_.value=(await r(async()=>{const{default:i}=await import("./chunks/suggestion-filter.B2b5Yr0b.js");return{default:i}},__vite__mapDeps([14,2,1]))).default});const w=u();p(async()=>{w.value=(await r(async()=>{const{default:i}=await import("./chunks/suggestion-basic.Be_ZNGi1.js");return{default:i}},__vite__mapDeps([15,1,2]))).default});const Z=u();p(async()=>{Z.value=(await r(async()=>{const{default:i}=await import("./chunks/mention.Crku5MJC.js");return{default:i}},__vite__mapDeps([16,1,2]))).default});const W=u();p(async()=>{W.value=(await r(async()=>{const{default:i}=await import("./chunks/template-editor.M0iLKevW.js");return{default:i}},__vite__mapDeps([17,1,2]))).default});const I=u();p(async()=>{I.value=(await r(async()=>{const{default:i}=await import("./chunks/word-limit.e7E627W3.js");return{default:i}},__vite__mapDeps([18,1,2]))).default});const q=u();p(async()=>{q.value=(await r(async()=>{const{default:i}=await import("./chunks/loading-state.BXMJ6W0f.js");return{default:i}},__vite__mapDeps([19,1,2]))).default});const e=z(!0),X=u();return p(async()=>{X.value=(await r(async()=>{const{default:i}=await import("./chunks/mode-switch.Q9MdoKMG.js");return{default:i}},__vite__mapDeps([20,1,2]))).default}),(i,t)=>{const o=V("ClientOnly");return P(),R("div",null,[t[19]||(t[19]=m('<h1 id="sender-消息输入框" tabindex="-1">Sender 消息输入框 <a class="header-anchor" href="#sender-消息输入框" aria-label="Permalink to &quot;Sender 消息输入框&quot;">​</a></h1><div class="danger custom-block"><p class="custom-block-title">重大版本升级 v0.4</p><p>Sender 在 v0.4 进行了重大升级。</p><p><strong>从 v0.3.x 升级？选择你的迁移方式：</strong></p><p><strong>方式一：快速迁移（推荐）</strong> 🚀</p><ul><li>使用 <code>SenderCompat</code> 组件，保持大部分 API 兼容</li><li>修改导入语句 + 处理少量破坏性变更</li><li>👉 查看 <a href="./sender-compat.html">SenderCompat 快速迁移指南</a></li></ul><p><strong>方式二：完全升级</strong> 📖</p><ul><li>直接升级到 v0.4，使用全新 API</li><li>需要调整代码，但能获得更好的功能和性能</li><li>⚠️ 部分 API 已被移除，详见下方 <a href="#已移除的-api">已移除的 API</a></li><li>👉 查看 <a href="./sender-compat.html#完整迁移方案">完整迁移方案</a></li></ul><p><strong>新项目：</strong> 直接使用下方 v0.4 的 API 和示例即可。</p></div><p>Sender 是一个高度可组合的聊天输入组件，支持文本输入、自动联想、提及功能、模板填充、语音输入和文件上传等多种功能。</p><ul><li><a href="#代码示例">代码示例</a> - 输入模式、状态控制、字数限制</li><li><a href="#输入增强">输入增强</a> - 模板填充、提及功能、智能联想、语音输入、文件上传</li><li><a href="#交互定制">交互定制</a> - 取消操作、提交方式、快捷键、自定义插槽、方法调用</li><li><a href="#样式配置">样式配置</a> - 主题支持、组件尺寸</li></ul><h2 id="代码示例" tabindex="-1">代码示例 <a class="header-anchor" href="#代码示例" aria-label="Permalink to &quot;代码示例&quot;">​</a></h2><h3 id="输入模式" tabindex="-1">输入模式 <a class="header-anchor" href="#输入模式" aria-label="Permalink to &quot;输入模式&quot;">​</a></h3><p>Sender 支持单行和多行两种输入模式，通过 <code>mode</code> 属性控制。</p><div class="tip custom-block"><p class="custom-block-title">单行模式自动切换</p><p>在单行模式下，当输入内容超出宽度时，会自动切换为多行模式。</p><p>当 <code>submitType=&quot;enter&quot;</code> 时，按 <code>Ctrl+Enter</code> 或 <code>Shift+Enter</code> 也会自动切换为多行模式并换行。</p></div>',8)),h(s(n(g),null,null,512),[[c,e.value]]),s(o,null,{default:a(()=>[s(n(y),{title:"输入模式",description:"支持单行和多行模式，单行模式可自动切换为多行。",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:t[0]||(t[0]=()=>{e.value=!1}),vueCode:n(at)},k({_:2},[X.value?{name:"vue",fn:a(()=>[s(n(X))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),t[20]||(t[20]=l("h3",{id:"状态控制",tabindex:"-1"},[d("状态控制 "),l("a",{class:"header-anchor",href:"#状态控制","aria-label":'Permalink to "状态控制"'},"​")],-1)),t[21]||(t[21]=l("p",null,[d("通过 "),l("code",null,"loading"),d(" 和 "),l("code",null,"disabled"),d(" 属性控制组件状态。加载状态下可点击图标取消操作。")],-1)),h(s(n(g),null,null,512),[[c,e.value]]),s(o,null,{default:a(()=>[s(n(y),{title:"加载与禁用状态",description:"展示加载和禁用两种状态的表现。",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:t[1]||(t[1]=()=>{e.value=!1}),vueCode:n(it)},k({_:2},[q.value?{name:"vue",fn:a(()=>[s(n(q))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),t[22]||(t[22]=m('<h3 id="内容管理" tabindex="-1">内容管理 <a class="header-anchor" href="#内容管理" aria-label="Permalink to &quot;内容管理&quot;">​</a></h3><h4 id="字数限制" tabindex="-1">字数限制 <a class="header-anchor" href="#字数限制" aria-label="Permalink to &quot;字数限制&quot;">​</a></h4><p>通过 <code>maxLength</code> 和 <code>showWordLimit</code> 属性实现字数限制和统计。</p><div class="warning custom-block"><p class="custom-block-title">超出限制行为</p><p>超出字数限制时，不会自动截断内容，但会以红色标示真实字数，且无法提交。</p></div>',4)),h(s(n(g),null,null,512),[[c,e.value]]),s(o,null,{default:a(()=>[s(n(y),{title:"字数限制",description:"限制输入字符数并显示字数统计。",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:t[2]||(t[2]=()=>{e.value=!1}),vueCode:n(et)},k({_:2},[I.value?{name:"vue",fn:a(()=>[s(n(I))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),t[23]||(t[23]=m(`<h2 id="输入增强" tabindex="-1">输入增强 <a class="header-anchor" href="#输入增强" aria-label="Permalink to &quot;输入增强&quot;">​</a></h2><p>Sender 采用可插拔的扩展架构，通过 <code>extensions</code> prop 灵活添加功能。所有扩展都支持响应式数据自动同步。</p><h3 id="扩展使用" tabindex="-1">扩展使用 <a class="header-anchor" href="#扩展使用" aria-label="Permalink to &quot;扩展使用&quot;">​</a></h3><p>提供两种集成方式：</p><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { TrSender } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;@opentiny/tiny-robot&#39;</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">interface</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> SenderExternalPayload</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">  readonly</span><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;"> source</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">:</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> string</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">  readonly</span><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;"> payload</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">:</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> unknown</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">interface</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> SenderSubmitExtra</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
