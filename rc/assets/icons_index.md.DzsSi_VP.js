const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/IconGallery.DRrq_JFz.js","assets/chunks/framework.PlJNRFak.js","assets/chunks/theme.DVNTz-UC.js","assets/chunks/BasicUsage.DK6dr2vQ.js"])))=>i.map(i=>d[i]);
import{aD as c,bQ as p,aZ as E,aL as _,v,H as d,bL as h,bB as k,J as i,bk as s,bJ as t,G as g,b7 as y,aU as b}from"./chunks/framework.PlJNRFak.js";import{L as u,N as m}from"./chunks/index.DQFFYRhS.js";const f=`<script setup lang="ts">
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><h2 id="样式与命名" tabindex="-1">样式与命名 <a class="header-anchor" href="#样式与命名" aria-label="Permalink to &quot;样式与命名&quot;">​</a></h2><ul><li>所有公开图标均以 <code>Icon</code> 作为前缀，例如 <code>IconSend</code>、<code>IconHistory</code>、<code>IconPlugin</code>。</li><li>图标尺寸建议通过 <code>fontSize</code>、<code>width</code> 或 <code>height</code> 控制。</li><li>图标颜色可优先通过 <code>color</code> 或 <code>fill</code> 调整，具体效果取决于 SVG 本身的配色方式。</li><li>本页下面的图标集合基于 <code>@opentiny/tiny-robot-svgs</code> 的公共导出生成。</li><li>插画型和场景态图标会在独立分组中展示，并使用单独的预览尺寸，避免影响常用图标浏览体验。</li></ul><h2 id="图标集合" tabindex="-1">图标集合 <a class="header-anchor" href="#图标集合" aria-label="Permalink to &quot;图标集合&quot;">​</a></h2><p>图标集合按常用场景分类展示，支持按图标名、分类名和关键词筛选；点击图标卡片可以快速复制图标名称。</p>`,12)),h(i(s(u),null,null,512),[[k,e.value]]),i(r,null,{default:t(()=>[i(s(m),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:n[1]||(n[1]=()=>{e.value=!1}),vueCode:s(f)},g({_:2},[o.value?{name:"vue",fn:t(()=>[i(s(o))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1})])}}});export{B as __pageData,A as default};
