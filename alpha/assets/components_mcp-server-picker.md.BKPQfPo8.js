const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/basic.BRGHqXW3.js","assets/chunks/theme.BpQeWh2r.js","assets/chunks/framework.BnsMRgQR.js","assets/chunks/popup-config.nPQp8w3r.js","assets/chunks/basic-usage.BcNJABKF.js"])))=>i.map(i=>d[i]);
import{D as p,v as c,V as k,p as v,C as E,c as A,o as D,j as a,af as g,G as t,a2 as F,a as u,ag as y,k as i,w as l,ai as b}from"./chunks/framework.BnsMRgQR.js";import{T as C}from"./chunks/basic.c4x2GtOB.js";import{R as m,k as f}from"./chunks/index.BwU78pWT.js";const P=`<template>
...
`,M=JSON.parse('{"title":"MCP Server Picker 插件选择器","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"components/mcp-server-picker.md","filePath":"components/mcp-server-picker.md"}'),B={name:"components/mcp-server-picker.md"},S=Object.assign(B,{setup(w){const d=p();c(async()=>{d.value=(await k(async()=>{const{default:s}=await import("./chunks/basic.BRGHqXW3.js");return{default:s}},__vite__mapDeps([0,1,2]))).default});const o=p();c(async()=>{o.value=(await k(async()=>{const{default:s}=await import("./chunks/popup-config.nPQp8w3r.js");return{default:s}},__vite__mapDeps([3,1,2]))).default});const e=v(!0),r=p();return c(async()=>{r.value=(await k(async()=>{const{default:s}=await import("./chunks/basic-usage.BcNJABKF.js");return{default:s}},__vite__mapDeps([4,1,2]))).default}),(s,n)=>{const h=E("ClientOnly");return D(),A("div",null,[n[3]||(n[3]=a("h1",{id:"mcp-server-picker-插件选择器",tabindex:"-1"},[u("MCP Server Picker 插件选择器 "),a("a",{class:"header-anchor",href:"#mcp-server-picker-插件选择器","aria-label":'Permalink to "MCP Server Picker 插件选择器"'},"​")],-1)),n[4]||(n[4]=a("p",null,"MCP Server Picker 组件是一个用于展示和管理插件的组件，支持已安装插件和插件市场两个标签页，可以进行插件的添加、删除和启用/禁用操作。",-1)),n[5]||(n[5]=a("h2",{id:"基础用法",tabindex:"-1"},[u("基础用法 "),a("a",{class:"header-anchor",href:"#基础用法","aria-label":'Permalink to "基础用法"'},"​")],-1)),g(t(i(m),null,null,512),[[y,e.value]]),t(h,null,{default:l(()=>[t(i(f),{title:"",description:"",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",visible:!0,onMount:n[0]||(n[0]=()=>{e.value=!1}),vueCode:i(x)},b({_:2},[r.value?{name:"vue",fn:l(()=>[t(i(r))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),n[6]||(n[6]=F(`<h3 id="插件添加状态" tabindex="-1">插件添加状态 <a class="header-anchor" href="#插件添加状态" aria-label="Permalink to &quot;插件添加状态&quot;">​</a></h3><p>市场插件支持三种添加状态，提供更好的用户体验：</p><ul><li><strong>idle</strong>: 未添加状态，显示&quot;添加&quot;按钮，用户可以点击添加</li><li><strong>loading</strong>: 添加中状态，显示&quot;添加中&quot;按钮，按钮不可点击，适用于网络请求等异步操作</li><li><strong>added</strong>: 已添加状态，显示&quot;已添加&quot;按钮，按钮不可点击</li></ul><p>通过 <code>addState</code> 属性控制插件的添加状态，开发者可以在添加插件的异步过程中动态更新状态，提升用户体验。</p><h4 id="状态控制示例" tabindex="-1">状态控制示例 <a class="header-anchor" href="#状态控制示例" aria-label="Permalink to &quot;状态控制示例&quot;">​</a></h4><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">const</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> handlePluginAdd</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> (</span><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;">plugin</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">:</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> PluginInfo</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">) </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=&gt;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div>`,48))])}}});export{M as __pageData,S as default};
