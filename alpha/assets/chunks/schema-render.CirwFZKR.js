import{d,a4 as p,p as h,b4 as f,c as u,o as x,j as r,G as a,w as _,k as e}from"./framework.eghS62D6.js";import{a as v,I as m,w}from"./theme.Cvt3ajCp.js";import c from"./schema-card.ce.Y-Hr2I7C.js";const C={style:{display:"flex","flex-direction":"column",gap:"16px"}},N=d({__name:"schema-render",setup(g){const n=p(w,{style:{fontSize:"32px"}}),i=new v({mdConfig:{html:!0},dompurifyConfig:{ADD_TAGS:["schema-card"],ADD_ATTR:["schema"]}}),s=h(JSON.stringify({state:{},methods:{},componentName:"Page",props:{},children:[{componentName:"Text",props:{text:"运行时渲染器文本"}},{componentName:"Button",props:{text:"运行时渲染器按钮"}}]}));if(!customElements.get("schema-card")){const o=f(c);customElements.define("schema-card",o)}const l=`# h1 Heading
## Emphasis
