const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/size.cv7hprfw.js","assets/chunks/theme.BaeaAL6B.js","assets/chunks/framework.D5IXmigW.js","assets/chunks/methods-demo.BEdtIMnJ.js","assets/chunks/custom-slots.BVtYxJ79.js","assets/chunks/submit-type.BkwDiaQT.js","assets/chunks/cancel-event.Cw_u7onY.js","assets/chunks/actions-enhanced.a4LcLu-7.js","assets/chunks/actions-config-basic.C_CyuUDB.js","assets/chunks/voice-custom-ui.C1Xq7hDS.js","assets/chunks/voice-custom.S_jSWDv_.js","assets/chunks/voice-input.gmk2U0B3.js","assets/chunks/suggestion-highlight.BMIEoXoZ.js","assets/chunks/suggestion-filter.DFRNxbC8.js","assets/chunks/suggestion-basic.B6gjM7YQ.js","assets/chunks/mention.b2_aDEsI.js","assets/chunks/template-editor.Dsu0y80t.js","assets/chunks/word-limit.DCrn7dn5.js","assets/chunks/loading-state.CeSJym9S.js","assets/chunks/mode-switch.DpDBieE9.js"])))=>i.map(i=>d[i]);
import{aD as o,bQ as p,aZ as X,aL as V,v as P,H as m,bL as r,bB as h,J as s,bk as n,bJ as a,G as c,w as l,I as k,b7 as u,aU as z}from"./chunks/framework.D5IXmigW.js";import{L as g,N as y}from"./chunks/index.BPwzYTgQ.js";const L=`<script setup lang="ts">
...
`,ot=JSON.parse('{"title":"Sender 消息输入框","description":"","frontmatter":{"outline":[1,3],"badge":"1.4.0"},"headers":[],"relativePath":"components/sender.md","filePath":"components/sender.md"}'),it={name:"components/sender.md"},pt=Object.assign(it,{setup(at){const E=u();o(async()=>{E.value=(await p(async()=>{const{default:i}=await import("./chunks/size.cv7hprfw.js");return{default:i}},__vite__mapDeps([0,1,2]))).default});const b=u();o(async()=>{b.value=(await p(async()=>{const{default:i}=await import("./chunks/methods-demo.BEdtIMnJ.js");return{default:i}},__vite__mapDeps([3,1,2]))).default});const v=u();o(async()=>{v.value=(await p(async()=>{const{default:i}=await import("./chunks/custom-slots.BVtYxJ79.js");return{default:i}},__vite__mapDeps([4,1,2]))).default});const f=u();o(async()=>{f.value=(await p(async()=>{const{default:i}=await import("./chunks/submit-type.BkwDiaQT.js");return{default:i}},__vite__mapDeps([5,2,1]))).default});const F=u();o(async()=>{F.value=(await p(async()=>{const{default:i}=await import("./chunks/cancel-event.Cw_u7onY.js");return{default:i}},__vite__mapDeps([6,1,2]))).default});const A=u();o(async()=>{A.value=(await p(async()=>{const{default:i}=await import("./chunks/actions-enhanced.a4LcLu-7.js");return{default:i}},__vite__mapDeps([7,1,2]))).default});const D=u();o(async()=>{D.value=(await p(async()=>{const{default:i}=await import("./chunks/actions-config-basic.C_CyuUDB.js");return{default:i}},__vite__mapDeps([8,1,2]))).default});const C=u();o(async()=>{C.value=(await p(async()=>{const{default:i}=await import("./chunks/voice-custom-ui.C1Xq7hDS.js");return{default:i}},__vite__mapDeps([9,2,1]))).default});const x=u();o(async()=>{x.value=(await p(async()=>{const{default:i}=await import("./chunks/voice-custom.S_jSWDv_.js");return{default:i}},__vite__mapDeps([10,1,2]))).default});const B=u();o(async()=>{B.value=(await p(async()=>{const{default:i}=await import("./chunks/voice-input.gmk2U0B3.js");return{default:i}},__vite__mapDeps([11,2,1]))).default});const T=u();o(async()=>{T.value=(await p(async()=>{const{default:i}=await import("./chunks/suggestion-highlight.BMIEoXoZ.js");return{default:i}},__vite__mapDeps([12,2,1]))).default});const S=u();o(async()=>{S.value=(await p(async()=>{const{default:i}=await import("./chunks/suggestion-filter.DFRNxbC8.js");return{default:i}},__vite__mapDeps([13,2,1]))).default});const _=u();o(async()=>{_.value=(await p(async()=>{const{default:i}=await import("./chunks/suggestion-basic.B6gjM7YQ.js");return{default:i}},__vite__mapDeps([14,1,2]))).default});const Z=u();o(async()=>{Z.value=(await p(async()=>{const{default:i}=await import("./chunks/mention.b2_aDEsI.js");return{default:i}},__vite__mapDeps([15,1,2]))).default});const w=u();o(async()=>{w.value=(await p(async()=>{const{default:i}=await import("./chunks/template-editor.Dsu0y80t.js");return{default:i}},__vite__mapDeps([16,1,2]))).default});const W=u();o(async()=>{W.value=(await p(async()=>{const{default:i}=await import("./chunks/word-limit.DCrn7dn5.js");return{default:i}},__vite__mapDeps([17,1,2]))).default});const I=u();o(async()=>{I.value=(await p(async()=>{const{default:i}=await import("./chunks/loading-state.CeSJym9S.js");return{default:i}},__vite__mapDeps([18,1,2]))).default});const e=z(!0),q=u();return o(async()=>{q.value=(await p(async()=>{const{default:i}=await import("./chunks/mode-switch.DpDBieE9.js");return{default:i}},__vite__mapDeps([19,1,2]))).default}),(i,t)=>{const d=X("ClientOnly");return V(),P("div",null,[t[18]||(t[18]=m('<h1 id="sender-消息输入框" tabindex="-1">Sender 消息输入框 <a class="header-anchor" href="#sender-消息输入框" aria-label="Permalink to &quot;Sender 消息输入框&quot;">​</a></h1><div class="danger custom-block"><p class="custom-block-title">重大版本升级 v0.4.0</p><p>Sender 在 v0.4.0 进行了重大升级。</p><p><strong>从 v0.3.0 升级？选择你的迁移方式：</strong></p><p><strong>方式一：快速迁移（推荐）</strong> 🚀</p><ul><li>使用 <code>SenderCompat</code> 组件，保持大部分 API 兼容</li><li>修改导入语句 + 处理少量破坏性变更</li><li>👉 查看 <a href="./sender-compat.html">SenderCompat 快速迁移指南</a></li></ul><p><strong>方式二：完全升级</strong> 📖</p><ul><li>直接升级到 v0.4.0，使用全新 API</li><li>需要调整代码，但能获得更好的功能和性能</li><li>⚠️ 部分 API 已被移除，详见下方 <a href="#已移除的-api">已移除的 API</a></li><li>👉 查看 <a href="./sender-compat.html#完整迁移方案">完整迁移方案</a></li></ul><p><strong>新项目：</strong> 直接使用下方 v0.4.0 的 API 和示例即可。</p></div><p>Sender 是一个高度可组合的聊天输入组件，支持文本输入、自动联想、提及功能、模板填充、语音输入和文件上传等多种功能。</p><ul><li><a href="#代码示例">代码示例</a> - 输入模式、状态控制、字数限制</li><li><a href="#输入增强">输入增强</a> - 模板填充、提及功能、智能联想、语音输入、文件上传</li><li><a href="#交互定制">交互定制</a> - 取消操作、提交方式、快捷键、自定义插槽、方法调用</li><li><a href="#样式配置">样式配置</a> - 主题支持、组件尺寸</li></ul><h2 id="代码示例" tabindex="-1">代码示例 <a class="header-anchor" href="#代码示例" aria-label="Permalink to &quot;代码示例&quot;">​</a></h2><h3 id="输入模式" tabindex="-1">输入模式 <a class="header-anchor" href="#输入模式" aria-label="Permalink to &quot;输入模式&quot;">​</a></h3><p>Sender 支持单行和多行两种输入模式，通过 <code>mode</code> 属性控制。</p><div class="tip custom-block"><p class="custom-block-title">单行模式自动切换</p><p>在单行模式下，当输入内容超出宽度时，会自动切换为多行模式。</p><p>当 <code>submitType=&quot;enter&quot;</code> 时，按 <code>Ctrl+Enter</code> 或 <code>Shift+Enter</code> 也会自动切换为多行模式并换行。</p></div>',8)),r(s(n(g),null,null,512),[[h,e.value]]),s(d,null,{default:a(()=>[s(n(y),{title:"输入模式",description:"支持单行和多行模式，单行模式可自动切换为多行。",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:t[0]||(t[0]=()=>{e.value=!1}),vueCode:n(et)},c({_:2},[q.value?{name:"vue",fn:a(()=>[s(n(q))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),t[19]||(t[19]=l("h3",{id:"状态控制",tabindex:"-1"},[k("状态控制 "),l("a",{class:"header-anchor",href:"#状态控制","aria-label":'Permalink to "状态控制"'},"​")],-1)),t[20]||(t[20]=l("p",null,[k("通过 "),l("code",null,"loading"),k(" 和 "),l("code",null,"disabled"),k(" 属性控制组件状态。加载状态下可点击图标取消操作。")],-1)),r(s(n(g),null,null,512),[[h,e.value]]),s(d,null,{default:a(()=>[s(n(y),{title:"加载与禁用状态",description:"展示加载和禁用两种状态的表现。",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:t[1]||(t[1]=()=>{e.value=!1}),vueCode:n(nt)},c({_:2},[I.value?{name:"vue",fn:a(()=>[s(n(I))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),t[21]||(t[21]=m('<h3 id="内容管理" tabindex="-1">内容管理 <a class="header-anchor" href="#内容管理" aria-label="Permalink to &quot;内容管理&quot;">​</a></h3><h4 id="字数限制" tabindex="-1">字数限制 <a class="header-anchor" href="#字数限制" aria-label="Permalink to &quot;字数限制&quot;">​</a></h4><p>通过 <code>maxLength</code> 和 <code>showWordLimit</code> 属性实现字数限制和统计。</p><div class="warning custom-block"><p class="custom-block-title">超出限制行为</p><p>超出字数限制时，不会自动截断内容，但会以红色标示真实字数，且无法提交。</p></div>',4)),r(s(n(g),null,null,512),[[h,e.value]]),s(d,null,{default:a(()=>[s(n(y),{title:"字数限制",description:"限制输入字符数并显示字数统计。",locale:"",select:"vue",order:"vue,react,html",github:"",gitlab:"",theme:"",lightTheme:"",darkTheme:"",stackblitz:"%7B%22show%22%3Afalse%7D",codesandbox:"%7B%22show%22%3Afalse%7D",codeplayer:"%7B%22show%22%3Afalse%7D",playground:"%7B%22show%22%3Atrue%7D",files:"%7B%22vue%22%3A%7B%7D%2C%22react%22%3A%7B%7D%2C%22html%22%3A%7B%7D%7D",scope:"",htmlWriteWay:"write",background:"undefined",visible:!0,onMount:t[2]||(t[2]=()=>{e.value=!1}),vueCode:n(st)},c({_:2},[W.value?{name:"vue",fn:a(()=>[s(n(W))]),key:"0"}:void 0]),1032,["vueCode"])]),_:1}),t[22]||(t[22]=m(`<h2 id="输入增强" tabindex="-1">输入增强 <a class="header-anchor" href="#输入增强" aria-label="Permalink to &quot;输入增强&quot;">​</a></h2><p>Sender 采用可插拔的扩展架构，通过 <code>extensions</code> prop 灵活添加功能。所有扩展都支持响应式数据自动同步。</p><h3 id="扩展使用" tabindex="-1">扩展使用 <a class="header-anchor" href="#扩展使用" aria-label="Permalink to &quot;扩展使用&quot;">​</a></h3><p>提供两种集成方式：</p><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { TrSender } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;@opentiny/tiny-robot&#39;</span></span>
